class InstructorProductDetailsModel{
  late bool hasError;
  late List<dynamic> errors;
  late List<dynamic> messages;
  late Data? data;

  InstructorProductDetailsModel.formJson(Map<String,dynamic> json){
...
class Data {
  Product? product;
  List<ProductsChapters>? productsChapters;


  Data.fromJson(Map<String, dynamic> json) {
    product =
    json['product'] != null ? new Product.fromJson(json['product']) : null;
    if (json['products_chapters'] != null) {
      productsChapters = <ProductsChapters>[];
      json['products_chapters'].forEach((v) {
        productsChapters!.add(new ProductsChapters.fromJson(v));
      });
    }
  }
...
class ProductsChapters {
  ...
  ProductsChapters.fromJson(Map<String, dynamic> json) {
