class InstructorProductModel{
  late bool hasError;
  late List<dynamic> errors;
  late List<dynamic> messages;
  late Data? data;

  InstructorProductModel.formJson(Map<String,dynamic> json){
...
class Products {
  ...
  String? postFilename;
  List<ProductThumbs>? productThumbs;
  String? status;
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product_thumbs'] != null) {
      productThumbs = <ProductThumbs>[];
      json['product_thumbs'].forEach((v) {
        productThumbs!.add(new ProductThumbs.fromJson(v));
      });
    }
    status = json['status'];
  }
...
class ProductThumbs {
  ...
  ProductThumbs({this.postFilename});

  ProductThumbs.fromJson(Map<String, dynamic> json) {
    postFilename = json['post_filename'];
  }
