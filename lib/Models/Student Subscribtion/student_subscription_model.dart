class StudentSubscriptionModel{
  late bool hasError;
  late List<dynamic> errors;
  late List<dynamic> messages;
  late Data? data;

  StudentSubscriptionModel.formJson(Map<String,dynamic> json){
...
class ProductsSubscriptions {
  ...
  ProductsSubscriptions.fromJson(Map<String, dynamic> json) {
    ...
    prosubscriptionSessionsRemaining = json['prosubscription_sessions_remaining'];
