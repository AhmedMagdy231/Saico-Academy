...
import 'package:saico_academy/Screens/Progrom%20Details/Widgets/pdf_buutton_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AppCubit, AppState>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          body: cubit.programDetailsModel == null
              ? buildLoadingWidget()
              : SafeArea(
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        if (cubit.programDetailsModel!.data!.imageSlider.isNotEmpty)
                          Column(
                            children: [
                              CarouselSliderWidget(
                                  ...
                                  images: cubit
                                      .programDetailsModel!.data!.imageSlider,
                                  cubit: cubit),
                              SizedBox(
                                height: height * 0.02,
                              ),
                              AnimatedSmoothIndicatorWidget(
                                  cubit: cubit,
                                  length: cubit.programDetailsModel!.data!
                                      .imageSlider.length),
                              SizedBox(
                                height: height * 0.02,
                              ),
                        ...
                        CategoryTextWidget(
                            text: cubit.programDetailsModel!.data!.product!
                                .productName!,
                            width: width,
                            height: height),
                        SizedBox(
                        ...
                        if (cubit.programDetailsModel!.data!.instructors!.isNotEmpty)
                          Column(
                            children: [
                              CategoryTextWidget(
                                  text: 'المدربين الحاليين',
                                  width: width,
                                  height: height),
                              InstructorOfCoursesWidget(
                                ...
                                width: width,
                                instructors: cubit
                                    .programDetailsModel!.data!.instructors!,
                              ),
                            ],
                          ),
                        ...
                        if (cubit.programDetailsModel!.data!.productsReviews!.isNotEmpty)
                          Column(
                            children: [
                              ...
                              ReviewStudentWidget(
                                height: height,
                                width: width,
                                reviews: cubit.programDetailsModel!.data!
                                    .productsReviews!,
                              ),
                            ],
                          ),
                        ...
                        Row(
                          ...
                          children: [
                            PDFButton(
                                path: cubit.programDetailsModel!.data!.product!.productIntroFilename!,
                                text: 'ملف المقدمة'
                            ),
                            PDFButton(
                                path: cubit.programDetailsModel!.data!.product!.productTermFilename!,
                                text: 'ملف الشروط',
                            ),
